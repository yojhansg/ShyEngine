...
PEditor::Preferences* PEditor::Preferences::instance = nullptr;
...
PEditor::ProjectData& PEditor::Preferences::GetData()
{
...
void PEditor::Preferences::GenerateDebug()
{
...
nlohmann::ordered_json PEditor::Preferences::BasicData()
{
