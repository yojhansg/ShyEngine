...
\item \textit{Autosuficiencia}: Esto siginifca que aporta funcionalidad para manejar recursos, crear escenas 
...
\item \textit{Editor integrado}: La principal herramienta de un motor autosuficiente es el editor, encargado 
...
\item \textit{Programación visual basada en nodos}: Esta es la parte a destacar de nuestro motor. Debido a la 
...
\subsection*{Etapa 1: Desarrollo Inicial}

La primera fase del trabajo consistirá en el desarrollo del núcleo de cada una de las tres partes por separado: 

\begin{itemize}
    \item \textit{Motor}: Para la parte del motor esta fase consistirá en la investigación de posibles librerías a utilizar, integración y 
    ...
    \item \textit{Editor}: Para la parte del editor esta fase consistirá en  en investigar librerías gráficas, con especial énfasis en aquellas adecuadas para la interfaz de usuario (UI). 
    ...
    \item \textit{Sistema de Scripting}: TODO
\end{itemize}

\subsection*{Etapa 2: Integración}
...
\begin{itemize}
    \item \textit{Motor}: Para la parte del motor esta fase consistirá en el desarrollo del bucle principal, funcionalidad requerida para la 
    comunicación motor-editor y terminar con el desarrollo de componentes y managers fundamentales.
    
    \item \textit{Editor}: Para la parte del editor esta fase consistirá en la lectura de los componentes del motor, su visualización y edición, así como en la serialización y lectura de las escenas,
...
\subsection*{Etapa 3: Mejoras y Pruebas}
...
\begin{itemize}
    \item \textit{Motor}: Para la parte del motor esta fase consistirá en realizar pruebas desde el editor y sistema de scripting para 
    comprobar el correcto funcionamiento de todas las partes del motor y arreglar lo necesario.    
    
    \item \textit{Editor}: Para la parte del editor esta fase consistirá en la implementación de una jerarquía entre entidades, la implementación de prefabs, la lectura de escenas serializadas, 
...
\subsection*{Phase 1: Inital development}

The first phase of the work will involve the development of the core of each of the three parts separately:

\begin{itemize}
    \item \textit{Engine}: For the engine part, this phase will involve researching potential libraries to use, integrating and ensuring basic
    ...
    \item \textit{Editor}: For the editor part, this phase will consist of researching graphic libraries, with special emphasis on those suitable for the user interface (UI). 
    ...
    \item \textit{Scripting System}: TODO
\end{itemize}
...
\begin{itemize}
    \item \textit{Engine}: For the engine part, this phase will involve developing the main loop, the required functionality for engine-editor 
    communication, and completing the development of essential components and managers.
    
    \item \textit{Editor}: For the editor part this phase will consist of reading the engine components, displaying and editing them, as well as serializing and reading the scenes,
    and other fundamental aspects for an editor, such as the implementation of the hierarchy window and the file explorer.

    \item \textit{Scripting System}: TODO
\end{itemize}

\subsection*{Phase 3: Improvements and debugging}
...
\begin{itemize}
    \item \textit{Engine}: For the engine part, this phase will involve conducting tests from the editor and scripting system to verify the correct
    functioning of all engine parts and making necessary fixes.
    
    \item \textit{Editor}: For the editor part this phase will consist of the implementation of a hierarchy between entities, the implementation of prefabs, the reading of serialized scenes, 
...
\textbf{\textit{TODO: User testing phase\ldots}}
