...
1.- Operación PUSH: Cuando se cambia una escena y se especifica está operación, añade la escena al top de la pila, por lo que la escena
añadida pasa a ser la que se actualiza en el juego. Antes de añadirla al top, llama al método OnSceneDown de la escena que está 
actualmente en el top para avisar de que esa escena va a dejar de actualizarse. Posteriormente, una vez añadida al top...
