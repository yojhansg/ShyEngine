...
Hemos decidido que los scripts funcionen como datos en vez de como código compilado, ahorrando tiempos de compilación y evitando depender de una programa externo para compilar el código, aunque esta forma de implementación implica que la ejecución del juego no estará tan optimizada, pues en vez de poder ejecutar código directamente, éste tiene que ser interpretado por el motor. Además esta solución también conlleva tener que almacenar la información para los scripts en ficheros externos.
