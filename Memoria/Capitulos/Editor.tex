...
\begin{enumerate}
    \item \textit{Gestor de proyectos}: Esta sección es la primera en iniciarse. En ella el usuario puede crear un proyecto o cargar uno ya creado.
    ...
    \item \textit{Edición de scripts}: Sección donde se maneja la creación y edición de scripts. Permite a los desarrolladores definir el comportamiento y la lógica del juego.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{Imagenes/Vectorial/ejemploScripting.png}
