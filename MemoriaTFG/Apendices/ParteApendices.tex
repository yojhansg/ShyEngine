...
\begin{itemize}
    ...
    \item "Custom data structures": Provide users with the ability to create custom data structures and group elements within the scripting system, which would increase flexibility and design options.
    
    \ÒExecute in the editorÓ: Allow users to run their games directly in the editor itself rather than in a separate window, which would streamline the development and testing process.
