...
\begin{itemize}
    ...
    \item \textit{Custom data structures}: Provide users with the ability to create custom data structures and group elements within the scripting system, which would increase flexibility and design options.
