...
Cabe destacar que el editor también soporta la modificación del layout de ventanas y personalización de la paleta de colores, como se ve en la imagen \ref{fig:personalizacionEditor}.
