...
Un aspecto importante del sistema de IDs es que también se utiliza para diferenciar las entidades normales de los prefabs\footnotemark. Los prefabs se distinguen por tener un ID negativo, lo que les permite ser identificados de manera única. Además, al modificar un prefab también se modifican todas sus instancias en la escena.
