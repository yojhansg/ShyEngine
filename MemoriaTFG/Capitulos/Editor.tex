...
Una funcionalidad a destacar del editor es la posibilidad de ejecutar el juego desde este en otra ventana. Esto se realiza ejecutando el ``.exe'' del motor a través de un hilo. Además tambien se puede generar una build ejecutable del juego. Esto permite a los desarrolladores crear una versión independiente del juego que puede ser distribuida y ejecutada por los usuarios finales. 
