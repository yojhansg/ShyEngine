...
Un motor de videojuego, es un entorno de desarrollo que proporciona herramientas para la creación de videojuegos. Su función principal es dotar al videojuego de un motor para
...
\begin{figure}[t]
    \centering
        \includegraphics[width=0.9\textwidth]{Imagenes/Vectorial/MotorSobreGameplay}
...
En el libro de Game Engine Arquitecture \cite{GameEngineArchitecture} se cita lo siguiente: "Se podría argumentar que una arquitectura orientada a datos es lo que diferencia a un motor de juego
