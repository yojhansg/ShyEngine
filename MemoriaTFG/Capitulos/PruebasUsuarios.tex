...
Por último, hay que mencionar que gracias a realizar las pruebas hemos encontrado bugs críticos tanto en el motor como en el editor, gracias principalmente a realizar las pruebas en el propio ordenador del usuario, y a usos del usuario del editor que no habíamos contemplado en un principio.
...
Consideramos que las pruebas con usuarios han sido realmente útiles, permitiéndonos ver que conceptos que dábamos por hecho que serían intuitivos realmente no lo son, y nos han servido para tomar nota de muchos posibles cambios y mejoras que habría que implementar para mejorar la calidad de la experiencia de usuario. 
\medskip
