...
Este proyecto es el que se encarga de mostrar las texturas y fuentes en pantalla, así como limpiar la pantalla o guardar información sobre ella. Hace uso de las librería de SDL, SDLImage y SDLTTF.
